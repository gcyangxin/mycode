...
class OsmToOsm:
	...
	def findallnode(self):
		...
		for one in self.selectway():
			...
			for t in node_id_list:#t=ref:'62894014
				self.fin_node[t]=all_node_dict.get(t)#{'62894014':('-82.9574098','42.428562')}
	...
	def write(self):
		...
		for x in fin_list:#('4216340519', ('-82.9371179', '42.4034025'))
			...
			self.osm[-1].tail='\n'
		for element_way in self.way_element_list:
			self.osm.append(element_way)
